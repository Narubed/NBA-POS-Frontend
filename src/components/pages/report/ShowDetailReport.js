                ...
                <Table sx={{ minWidth: 700 }} aria-label='spanning table'>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell align='right'>
                        {numeral(row.report_grand_total + row.report_discount).format('0,0.00')}
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell colSpan={2}>ส่วนลดท้ายบิล</TableCell>
                      <TableCell align='right'> {numeral(row.report_discount).format('0,0.00')}</TableCell>
                    </TableRow>
                    <TableRow>
