...
function ProductCreate({ showDrawerCreate, setDrawerCreate, findEmployees }) {
  ...
  const headleSubmit = async () => {
    ...
    if (!values.employee_name || !values.employee_email || !values.employee_password || !values.employee_phone) {
      setAlert(true)
      setTimeout(() => {
        setAlert(false)
      }, 2000)
      ...
      if (file.length !== 0) {
        ...
        formData.append('employee_branch_id', isBranch)
          ...
          <DialogContentText id='alert-dialog-slide-description'>
            ...
            >
              ...
              <List sx={{ p: '0px 20px' }}>
                ...
                <ListItem disablePadding>
                  {/* <FormControl fullWidth sx={{ m: 1 }} variant='standard'>
                    <InputLabel htmlFor='employee_type'>ตำเเหน่ง</InputLabel>
                    <Input
                      id='employee_type'
